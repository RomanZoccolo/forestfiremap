...
const pictures = [
	{
		file: '01-syamozero',
		description: {
			en:'Forest fire near Lake Syamozero, Republic of Karelia.',
			ru:'Пожар рядом с озером Сямозеро, Карелия.',
		}
	}, {
		file: '02-megino-aldan',
		description: {
			en:'Forest fire near the Aldan River, Republic of Sakha (Yakutia).',
			ru:'Лесной пожар рядом с рекой Алдан, Республика Саха (Якутия).',
		}
	}, {
		file: '03-sitte',
		description: {
			en:'The Sitte village surrounded by fires, near the Lena River, Republic of Sakha (Yakutia).',
			ru:'Окруженный пожарами посёлок Ситте недалеко от реки Лена, Республика Саха (Якутия).',
		}
	}, {
		file: '04-yakutsk',
		description: {
			en:'The city of Yakutsk in the smoke of forest fires, the Republic of Sakha (Yakutia). On days of dense smoke, according to IQAir, air pollution in Yakutsk exceeded the parameters recommended by the World Health Organization (WHO) by more than a hundred times.',
		...
		description: {
			en:'Surroundings of the city of Mirny on fire, the Republic of Sakha (Yakutia).',
			ru:'Окрестности города Мирный охвачены огнём, Республика Саха (Якутия).',
		}
	}, {
		file: '06-sangar',
		description: {
			en:'Forest fires on both sides of the Lena River, Republic of Sakha (Yakutia). The Verkhoyansk ridge is visible on the right side of the image.',
		...
		file: '07-byas-kyol',
		description: {
			en:'Byas-Kyuel village suffer from forest fire, Republic of Sakha (Yakutia).',
			ru:'Огонь лесных пожаров перекинулся на посёлок Бясь-Кюель, Республика Саха (Якутия).'
		}
	}, {
		file: '08-bur',
		description: {
			en:'A forest fire near a cluster of the Yarakt petroleum field, Irkutsk Region. Forest cuts are visible as light green spots on the picture.',
			ru:'Лесной пожар рядом с кустом скважин Ярактинского нефтегазоконденсатного месторождения, Иркутская область. Светло-зелеными пятнами на снимке различимы лесные вырубки.'
		}
	}, {
		file: '09-irkutskaya',
		description: {
			en:'A cluster of the Verkhnechonsk petroleum field and surrounding forest on fire, Irkutsk Region.',
			ru:'Пожар охвативший территорию куста Верхнечонского нефтегазоконденсатного месторождения и окружающий лес, Иркутская область.'
		}
	}, {
		file: '10-angara',
		description: {
			en:'Smoke from forest fires over forest cuts near the Angara River, Irkutsk Oblast.',
